...
const numbers = text.split('\n').map((row, index) => {
  return {
    number: parseInt(row) * DECRYPTION_KEY,
    originalIndex: index
  }  
})
...
console.log(numbers)
sortNumbers()
console.log('---sorted twice----');
console.log(numbers)
sortNumbers()
console.log('---sorted 3 times----');
console.log(numbers)
sortNumbers()
console.log('---sorted 4 times----');
console.log(numbers)
sortNumbers()
console.log('---sorted 5 times----');
console.log(numbers)
sortNumbers()
console.log('---sorted 6 times----');
console.log(numbers)
sortNumbers()
console.log('---sorted 7 times----');
console.log(numbers)
sortNumbers()
console.log('---sorted 8 times----');
console.log(numbers)
sortNumbers()
console.log('---sorted 9 times----');
console.log(numbers)
sortNumbers()
console.log('---sorted 10 times----');
console.log(numbers)
